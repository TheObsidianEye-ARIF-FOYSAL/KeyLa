...
/// 'https://your-host.example.com/server'. Left overridable so the app
/// doesn't hardcode a production endpoint.
final syncBaseUrlProvider = Provider<String>((ref) => 'https://example.com/server');
